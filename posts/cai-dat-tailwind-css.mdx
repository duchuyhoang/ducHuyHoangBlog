...
<Layout>
  <PostHeader 
  header="Tìm hiểu về Tailwind CSS và cài đặt cho dự án React" 
...
[bài tiếp theo](/post/cach-dung-tailwind) của mình để biết được các cú pháp lẫn tiện ích 
của Tailwind nha
...
<Tags 
tags={["News", "Tech","Tailwind CSS"]}
/>

<Comment slug={'cai-dat-tailwind-css'} />
